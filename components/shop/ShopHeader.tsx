  ...
  return (
    <>
      ...
      <div className="hidden lg:block">
        {/* Top Header */}
        <header className="bg-white text-black border-b-2 border-gray-500 p-4 shadow-lg">
            ...
            <div className="flex items-center justify-between h-16">
              ...
              >
                <Image
                  ...
                  width={178}
                  height={72}
                  className="rounded-xl shadow-sm w-28"
                />
              </Link>
              ...
              <div className="flex-1 max-w-2xl mx-8">
                <div className="relative">
                  <input
                    type="text"
                    placeholder="Search on MoMo"
                    className="w-full h-12 pl-4 pr-12 rounded-2xl border-0 shadow-sm focus:ring-2 focus:ring-white/20 focus:outline-none bg-white/95 backdrop-blur-sm text-slate-700 placeholder-slate-500"
                  />
                  <button title="ff" className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-slate-100 hover:bg-slate-200 rounded-xl flex items-center justify-center transition-colors">
            ...
            <div className="flex items-center gap-3 h-16 px-4">
              ...
              <div className="flex-1">
                <input
                  ...
                  placeholder="Search on MoMo"
                  autoFocus
                  className="w-full h-10 px-4 rounded-xl border-0 shadow-sm  focus:outline-none bg-white text-slate-700 placeholder-slate-500"
                />
              </div>
              <button title="f" className="w-10 h-10 bg-black hover:bg-slate-900 rounded-xl flex items-center justify-center transition-colors">
            ...
            {mobileNavItems.map((item, index) => {
              ...
              return (
                <Link
                  key={item.label}
                  href={item.href}
                  className={`flex flex-col items-center justify-center gap-1 px-3 py-2 rounded-xl transition-all duration-300 ${item.active ? "text-blue-800 " : "text-black "
                    }`}
                >
                  <div className="relative">
